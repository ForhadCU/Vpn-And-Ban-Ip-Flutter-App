...
class MyVpnScreen extends StatefulWidget {
  const MyVpnScreen({super.key});

  @override
  State<MyVpnScreen> createState() => _MyVpnScreenState();
}

class _MyVpnScreenState extends State<MyVpnScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("Create Custom Vpn")),
      body: ListView(
